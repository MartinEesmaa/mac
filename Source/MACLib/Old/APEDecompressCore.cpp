...
void CAPEDecompressCore::GenerateDecodedArray(int * Input_Array, unsigned __int32 Number_of_Elements, int Frame_Index, CAntiPredictor *pAntiPredictor, int CPULoadBalancingFactor)
{
