...
#define MAC_VERSION_STRING                              _T("4.19")
#define MAC_NAME                                        _T("Monkey's Audio 4.19")
#define PLUGIN_NAME                                     "Monkey's Audio Player v4.19"
#define MJ_PLUGIN_NAME                                  _T("APE Plugin (v4.19)")
#define CONSOLE_NAME                                    _T("--- Monkey's Audio Console Front End (v 4.19) (c) Matthew T. Ashland ---\n")
#define PLUGIN_ABOUT                                    _T("Monkey's Audio Player v4.19\nCopyrighted (c) 2000-2017 by Matthew T. Ashland")
