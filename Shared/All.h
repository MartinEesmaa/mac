...
// Windows based IO (Win32 API) -- typically faster
#define IO_USE_WIN_FILE_IO
#define IO_HEADER_FILE			"WinFileIO.h"
#define IO_CLASS_NAME			CWinFileIO

// Standard library IO -- generally slower, but should work cross-platform
...
// Global defines
////////////////////////////////////////////////////////////////////////////////////
#define MAC_VERSION_NUMBER						3950
#define MAC_VERSION_STRING						"3.95a2"
#define PLUGIN_NAME								"Monkey's Audio Player v3.95a2"
#define MJ_PLUGIN_NAME							"APE Plugin (v3.95a2)"
#define CONSOLE_NAME							"--- Monkey's Audio Console Front End (v 3.95a2) (c) Matthew T. Ashland ---\n"
#define PLUGIN_ABOUT							"Monkey's Audio Player v3.95a2\nCopyrighted (c) 2000-2002 by Matthew T. Ashland"
...
#define MBN(NUMBER) { char buf[10]; ltoa(NUMBER, buf, 10); ::MessageBox(NULL,buf,"Message...",MB_OK); }
...
#define ODN(NUMBER) { char buf[32]; wsprintf(buf, "%d\r\n", NUMBER); OutputDebugString(buf); }
...
#define EXPAND_128_TIMES(CODE) CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE
#define EXPAND_256_TIMES(CODE) CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE CODE
